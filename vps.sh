...
PS1='${debian_chroot:+($debian_chroot)}\[\033[0;96m\]\u\[\033[1;97m\]@\033[1;94m\]\h\[\033[0;94m\]\[\033[1;97m\]:\[\033[0;96m\]ჟ\[\033[0;97m\]\w\[\033[0;94m\]$ '
...
# +++ (OLD) Copying ssh keys to new user dir (if not root) +++
#sudo cp -r -d /root/.ssh/ ~/
...
Make sure your ssh keys were copied to /home/$USER/.ssh/authorized_keys
You can easily copy the keys from root to your home folder using the command below:
sudo cp -r -d /root/.ssh/ ~/
